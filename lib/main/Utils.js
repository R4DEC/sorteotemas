...
function getNumber(numberList) {
    if (numberList.length > 0 ) {
        ...
        alert('NO QUEDAN ALUMNOS POR ASIGNAR');
        return 'INTRODUCE OTRO Nº DE ALUMNOS';
    }
}
